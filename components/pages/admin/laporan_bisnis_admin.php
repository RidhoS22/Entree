    ...
    <div class="wrapper">
        ...
        <div class="main p-3">
            ...
            <div class="main_header">
                <?php 
                    $pageTitle = "Laporan Bisnis Kewirausahaan"; // Judul halaman
            ...
            <div class="main_wrapper">
                <div class="card">
                    ...
                    <a href="detail_laporan_bisnis.php">
                        <div class="card-body">
                        <p>Lorem ipsum dolor sit amet consectetur t. Sapiente at quidem commodi. Lorem ipsum dolor, sit amet consectetur adipisicing elit. Perferendis sus adipisicing elit. Saaoluptate cum.</p>
                        <hr>
