        ...
        <div class="notification-popup" id="notificationPopup">
            <div class="notification-content">
                ...
                <ul>
                    ...
                    <li>
                        <strong>Mentor Bisnis Baru:</strong> Anda telah ditugaskan ke kelompok 'Tech Startups' untuk mentoring bisnis.
                        <p class="notif-time">11:15 AM</p>
                    </li>
                    <li>
                        <strong>Proposal Kelompok:</strong> Proposal bisnis kelompok 'Creative Solutions' telah disetujui.
